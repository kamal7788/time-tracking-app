...
import {
  ClockIcon, CalendarIcon, HomeIcon, UsersIcon, ChartIcon,
  SettingsIcon, LogoutIcon, MenuIcon, XIcon, FolderIcon, ReceiptIcon,
  UmbrellaIcon, BriefcaseIcon,
} from '@/components/ui/icons'

const navigation = [
  { name: 'Dashboard', href: '/admin', icon: HomeIcon, exact: true },
  { name: 'Time Entries', href: '/admin/time-entries', icon: ClockIcon },
  { name: 'Leave Requests', href: '/admin/leaves', icon: UmbrellaIcon },
  { name: 'Leave Types', href: '/admin/leave-types', icon: CalendarIcon },
  { name: 'Leave Balances', href: '/admin/leave-balances', icon: ChartIcon },
  { name: 'Clients & Projects', href: '/admin/clients', icon: BriefcaseIcon },
  { name: 'Expenses', href: '/admin/expenses', icon: ReceiptIcon },
