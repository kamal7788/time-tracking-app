...
export async function GET(
  ...
  try {
    ...
    return handleApiError(error, 'Get leave type error:')
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return handleApiError(error, 'Update leave type error:')
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return handleApiError(error, 'Delete leave type error:')
  }
}